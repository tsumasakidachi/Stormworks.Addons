...
function onCustomCommand(full_message, user_peer_id, is_admin, is_auth, command, verb, ...)
    ...
    elseif verb == "wind" and is_admin then
        local min, max, clear = ...
        g_savedata.weather.wind.target_min = tonumber(min) or 0
        g_savedata.weather.wind.target_max = tonumber(max) or 0
        g_savedata.weather.wind.clear = tonumber(clear) or 0
    elseif verb == "rain" and is_admin then
        local min, max, clear = ...
        g_savedata.weather.rain.target_min = tonumber(min) or 0
        g_savedata.weather.rain.target_max = tonumber(max) or 0
        g_savedata.weather.rain.clear = tonumber(clear) or 0
    elseif verb == "fog" and is_admin then
        local min, max, clear = ...
        g_savedata.weather.fog.target_min = tonumber(min) or 0
        g_savedata.weather.fog.target_max = tonumber(max) or 0
        g_savedata.weather.fog.clear = tonumber(clear) or 0
    end
end
