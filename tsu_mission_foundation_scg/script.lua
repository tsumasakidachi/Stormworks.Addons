...
locations = {
  ...
  is_suitable = function(self, location, center, range_min, range_max)
    ...
    if location.tile == "" then
      ...
      if table.contains(location.landscape, "offshore") then
  ...
  random = function(self, center, range_min, range_max, patterns, is_main, ignore_duplication, ignore_difficulty, ignore_geologic, ignore_history)
    ...
    for i = #_locations, 1, -1 do
      ...
      if _locations[i].tile == "" then
        ...
        if table.contains(_locations[i].landscape, "offshore") then
...
landscapes = {
  ...
  is_suitable = function(self, zone, location, center, range_min, range_max)
    return self:is_in_range(zone, center, range_min, range_max) and
        table.contains(location.landscape, zone.landscape)
  end,
