...
g_savedata = {
    ...
    mission_mapped = true,
    mission_spawn_when_players_x = property.slider("New mission occurs when the number of missions is less than players divided by", 1, 10, 1, 3),
...
mission_trackers = {
    sar = {
        ...
        tick = function(self, mission, tick)
            ...
            if not mission.units.sar and rescuee_count >= 1 then
